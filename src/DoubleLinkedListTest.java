...
class DoubleLinkedListTest {
     ...
     * new element.
     *
     * @throws CouldNotAddException Could not add error.
     */
    @Test
    ...
    @DisplayName("Removing from front "
            + "of empty list throws CouldNotRemoveException")
     ...
     * added element..
     *
     * @throws CouldNotAddException couldNotAdd error.
     * @throws CouldNotRemoveException couldNotRemove error.
     */
    @Test
     ...
     */
    @Test
    @DisplayName("Removing from end of "
            + "empty list throws CouldNotRemoveException")
